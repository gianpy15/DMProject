"""
This module implements redefines multioutput regression and classification
in order to support 'object' type of arrays.

The following ones are clones of sklearn original classes and their behaviour is
preserved.
"""
